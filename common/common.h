...
#define CONFFILE        "C:\\Project\\Qt_Project\\YunDemo\\conf\\cfg.json"     // 配置文件
#define RECORDDIR       "C:\\Project\\Qt_Project\\YunDemo\\conf\\record\\"      // 用户文件上传下载记录
#define FILETYPEDIR     "C:\\Project\\Qt_Project\\YunDemo\\conf\\fileType"     // 存放文件类型图片目录
